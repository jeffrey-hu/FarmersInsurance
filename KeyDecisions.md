...
- **Requests for Admission:** the `.docx` was rebuilt September 19, 2026 after a full revision pass — the set now runs **Nos. 1–200** in sections A–T (+18 requests, 6 deleted, 6 reworded, 11 relocated, and 19 moved to the Second Set as its Part 5). Old→new numbers: Table F of `Filings/RequestForAdmission/FirstSet/RFA_Renumbering_Map_2026-09-16_Final.md`; decisions: `…/RFA_First_Set_Adversarial_Review_2026-09-18.md` §§5A–5G. Nothing blocks it now. Date it, sign it, and serve it.
- **Interrogatories:** still blocked by the inaccurate Rule 33.01(a) certification.

~~The unverified RFA 23~~ is **resolved** (September 16, 2026). Checked against the award image, the old request ("Greg Tomes did not sign The Appraisal Award") was wrong as drafted: Tomes signed the umpire-appointment block, and left blank only his line under "We certify the amounts established above." The request was rewritten and is now **First Set No. 32**, with a companion at **No. 33** (renumbered 9/19/2026; they were Nos. 29–30), under the final numbering of September 16, 2026 (`Filings/RequestForAdmission/FirstSet/RFA_Renumbering_Map_2026-09-16_Final.md`). ✅ Both were verified by Bill against the award on September 16, 2026.
