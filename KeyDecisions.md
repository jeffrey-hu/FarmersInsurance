...
- **Requests for Admission:** the set now runs **Nos. 1–185** in sections **A–V**, 20 pages. It was rebuilt September 19, 2026 after a full revision pass (which took it to Nos. 1–200 in sections A–T: +18 requests, 6 deleted, 6 reworded, 11 relocated, and 19 moved to the Second Set as its Part 5), and was then **trimmed the same day by Jeffrey's review, which removed 21 requests** — producing the current numbering. Old→new numbers: Tables F **and G** of `Filings/RequestForAdmission/FirstSet/RFA_Renumbering_Map_2026-09-16_Final.md`; decisions: `…/RFA_First_Set_Adversarial_Review_2026-09-18.md` §§5A–5G. Certificate dates filled **September 20, 2026**, and the attorney registration numbers were removed from the certificate (interrogatory review tracker **F-40**). Remaining: sign, export to PDF, serve before 5:00 p.m.
