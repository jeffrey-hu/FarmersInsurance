...
|---|---|---|---|---|---|---|
| First Set to FIE | **not yet served** | 14 *(numbered 2–6, 9–13, 17–20 — gaps at 1, 7, 8, 14, 15 and 16)* | 23 | **26** | 26 | **24** |

**How the 26 is built:** 26 for the set as originally drafted (Interrogatories 6, 10 and 13 each pose two separate questions; 7 and 17 carry four lettered subparts each) · +1 Interrogatory 3's decision-maker clause (I-10) · +6 Interrogatory 18, entity identity (I-13) · +1 Interrogatory 19, persons with knowledge (I-14) · +1 Interrogatory 20, destroyed information (I-16) · **−4 Interrogatory 7, removed September 12 and converted to Requests for Admission 61–65 (I-21 / RFA item A-10)** · **−1 Interrogatory 14, removed September 12, its *Quade* lock moved to Request for Admission 66 (I-22 / RFA item A-11)** · **−1 Interrogatory 16, removed September 12, its litigation-hold question moved to Requests for Admission 67–68 (I-23 / RFA item A-12)** · **−1 Interrogatory 8, deferred September 12 to `SecondSetDiscovery/Plaintiffs_Second_Set_of_Interrogatories_to_FIE_DRAFT.md` (I-25)** · **−1 Interrogatory 1, removed September 12 and re-issued as Instruction 10 (I-27) — a saving that repeats in every set served hereafter** · **−1 Interrogatory 15, dropped September 12, its defense-universe lock moved to Requests for Admission 41–47 (I-33 / RFA item A-6)**.

**Two counts, deliberately.** The lettered-subpart figure (23) is what a generous reading gives; the careful figure (26) is what Plaintiffs should plan against. ⚠️ **One of the 27 is genuinely arguable:** the reconciliation clause added to Interrogatory 11 on September 12 (item I-31) counts as 1 on the better view, but an adversary could call the relationship between two different statements a separate question and press for **27**. Plan against 27. On an aggressive reading of the "for each" constructions in Interrogatories 3, 4 and 12, an adversary could press toward the low 40s — which is why the served certification states a ceiling ("fewer than forty (40)") rather than an exact number.

**Pending removals would cut this further.** I-21 (−4), I-22 (−1), I-23 (−1), I-25 (−1), I-27 (−1) and I-33 (−1) are applied. **One count-reducing item remains open — I-24** (−2), which *trims* Interrogatory 17 from four lettered subparts to two. Interrogatory 17 stays in the set, so this changes the count but not the numbering; it would take the careful count to **24**, leaving about 26 in reserve. **Re-verify the certification ceiling before service.**

**Already spoken for out of the reserve:** the basis for any denial of Requests for Admission 61–65 (1) · a follow-up to Interrogatory 6 keyed to specific 2020 line items (2) · a post-production gap follow-up (2) · the expert interrogatory once FIE designates on April 17, 2027 (1–2) · the litigation-hold question if RFP 14's response is evasive (1) · the J6944 question once FIE asserts the endorsement (1) · the anticipation-of-litigation date if FIE claims work product (1) · roughly 5 held against the counting risk.
...
- [ ] **BLOCKING — renumber the interrogatory set.** As of September 12, 2026 it runs **2–6, 9–13, 17–20**; Interrogatories 1, 7, 14, 15 and 16 were removed and 8 deferred, under proposal items I-21, I-22, I-23, I-25, I-27 and I-33. **Every removal that creates a gap is now applied, so this renumbering is unblocked.** Two open items still change content: **I-24** trims Interrogatory 17's subparts and **I-26** narrows Interrogatory 4 — neither affects numbering. The one exception is **I-28 Option B**, which would merge Interrogatory 2 into Interrogatory 4 and delete No. 2; decide I-28 before renumbering, or renumber now and redo it if Option B is chosen. Do the renumbering **once, after every removal decision is final**, and write a mapping table (old № → new №) into the proposal file at the same time. Roughly **133 references to specific interrogatory numbers across nine project files** must then be re-checked against that table — the proposal and review files for all three sets, the RFA proposal, the preservation note, the Answer analysis, the second-set draft, and this README.
- [ ] **Re-verify the Rule 33.01(a) certification ceiling** against the budget tally in Section A. It currently reads "fewer than forty (40)" against a careful count of 26.
