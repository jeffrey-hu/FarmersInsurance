...
> **⚠️ RFA numbers in this file were corrected on September 19, 2026** to the renumbered set (Nos. 1–185, commit `f9cf092`). Re-verify before citing in a filing.

**The rule.** Minn. R. Civ. P. 33.01(a): *"No party may serve more than a total of 50 interrogatories upon any other party unless permitted to do so by the court upon motion, notice and a showing of good cause. In computing the total number of interrogatories each subdivision of separate questions shall be counted as an interrogatory."*

**Two columns below.** **Fair count** treats a subpart as part of the primary question where it is subsumed within and necessarily related to it — the reading courts generally apply to "state X, identifying Y and Z." **FIE's aggressive count** treats every requested data point as its own interrogatory and multiplies it across each enumerated item. The aggressive column is not a concession; it is the exposure to plan around.

| No. | Subject | Fair | **Likely (FIE's best defensible count)** | Aggressive | Where the exposure is |
|---:|---|---:|---:|---:|---|
...
| 7 | First Affirmative Defense and party identity | 2 | **3** | 7 | **Restructured 9/19/2026:** the counts clause folded in as a particular, and a new particular asks whether the jurisdictional allegation means subject-matter, personal, or both. Two questions remain: the basis for the pleaded defense, and — conditionally — who the right party is. The "does FIE contend it" half is carried by **RFAs 157–159 and 173**; the interrogatory supplies the **name**, which no RFA can |
...
**Fair count 17 of 50.** With 2 reserved for expert interrogatories under Rule 26.02(e)(1)(A), that leaves about 26 for the Second Set.

**Likely count 27 of 50 — this is the number to plan against.** It counts as separate only those clauses that can be answered without answering the primary question, which is the test a court would actually apply. The set is still under the cap, and no single interrogatory is indefensible. But the headroom is **23**.
...
## If FIE objects on numerosity

1. **Answer the objection, not the number.** Under Rule 33.01(a) a "subdivision of separate questions" counts separately; a clause that is subsumed within and necessarily related to the primary question is not a separate question. "State what You did with each submission, identifying each person involved" asks one thing and then asks who did it — not two things.
2. **Rule 26.02(b) proportionality favors Plaintiffs.** FIE holds the claim file, the vendor contracts and the personnel records; relative access and the importance of the issues both sit with it.
3. **Rule 33.01(c)** requires an objection stated with particularity, and **Rule 37.01** treats an evasive or incomplete answer as a failure to answer, with fee-shifting.
4. **Scheduling Order ¶4** controls the path: meet and confer, then a three-page letter requesting a conference call, before any formal motion.
5. **The fallback that costs least:** if a court ever counts aggressively, offer to withdraw or defer the multiplying clauses in Ints. 5 and 10 rather than lose the set. Neither withdrawal damages the case — Ints. 5 and 10 are backed by RFAs and by the RFP production.

## Second Set budget

| Held draft | Where | Estimated fair count |
|---|---|---:|
| J6944 / matching | Draft Interrogatory No. 1 | 2 |
| Award scope and present contentions | Draft Interrogatory No. 2 | 2 |
| Prieve engagement scope | Draft Interrogatory No. 3 | 2 |
| October 10 / October 29, 2025 reconciliation | Draft Interrogatory No. 4 | 2 |
| § 604.18, subd. 4(c) bar | Draft Interrogatory No. 5 | 1 |
| Expert interrogatories (reserved) | — | 2 |
| | **Total if all are served** | **11** |

**24 + 11 = 35 of 50** on the fair count, leaving roughly 15 for anything the responses turn up.
