...
> `Plaintiffs_First_Set_of_Interrogatories_to_FIE.docx` and `.md` are **untouched**. This file is a proposal only. Approve, reject, or edit item by item; I will apply only what you approve.
...
**Section VII is the budget review — read it first.** It recommends removing or converting six items from the current set, which frees 9 interrogatories. **Section V is the original budget table**; Section VII supersedes it. Read it before approving the new interrogatories — the 50-interrogatory cap is cumulative across every set you will ever serve on FIE, and the additions here would consume most of the remaining room.
...
| I-32 | **Sharpen Interrogatory 9's identifiers**; add a Dates instruction — now Instruction 11 | ✅ **Applied (both)** | — |
| I-33 | **Drop Interrogatory 15** — defense-universe lock moves to RFA item A-6 | ✅ **Applied** — ⚠️ A-6 still unapproved | — |

### Note — why there is no general expert interrogatory

An earlier draft of the review proposed asking FIE to identify its trial experts. **Dropped, at your direction, and you were right.** FIE's expert designation is due **April 17, 2027** under Scheduling Order ¶3, so asking today yields "not yet determined" and spends a slot from a cumulative budget.

One correction to the reasoning, though, because it matters for planning: the **September 25, 2026 initial disclosures will not identify FIE's experts**. Rule 26.01(a) covers only (A) individuals with discoverable information, (B) documents, (C) a damages computation, and (D) insurance agreements. Expert designation is Rule 26.01(b), and the Scheduling Order separates them expressly — ¶2(a) for the 26.01(a) disclosures, ¶3 for the 26.01(b) expert disclosures. What you should get on September 25 is a **fact-witness list**, which likely names Prieve, the Hancock inspector, and the adjusters, with the subjects of their knowledge — useful, but not opinions, grounds, or a report.
...
**Proposed:** change the citation to **Minn. R. Civ. P. 33.03**.
...
**Proposed:** change to **subd. 4(c)**.

**Why.** Subdivision 4 reads:

| ¶ | Content |
|---|---|
| 4(a) | The complaint must not seek recovery under the section; a party may later move to amend |
| 4(b) | Taxable costs are determined by the court **after** the fact-finder's determination, governed by Gen. R. Prac. 119 |
...
The appraisal bar is **4(c)** — the defense this interrogatory exists to attack, and the cleanest defense FIE has to the § 604.18 claim you have reserved. As written, the question asks FIE about the post-verdict procedural rule, which is incoherent and gives FIE a clean basis to say it does not understand the question.
...
> Pursuant to Minn. R. Civ. P. 33.01(a), Plaintiffs state that the foregoing interrogatories number seventeen (17) and, including all **discrete subparts**, do not exceed the fifty (50) interrogatories permitted without leave of court. …

**Proposed:**

> Pursuant to Minn. R. Civ. P. 33.01(a), Plaintiffs state that the foregoing interrogatories, counting each subdivision of separate questions as an interrogatory, number fewer than [NN] and do not exceed the fifty (50) interrogatories permitted without leave of court. Plaintiffs reserve the right to serve additional interrogatories by stipulation or upon leave of court.

**Why.** Two problems. "Discrete subparts" is the **federal** phrase; Minn. R. Civ. P. 33.01(a) says "In computing the total number of interrogatories **each subdivision of separate questions** shall be counted as an interrogatory." And "seventeen" is the count of numbered paragraphs, not of interrogatories: Interrogatories 7 and 17 carry four lettered subparts each, which makes the real figure **23** today. Stating a number you cannot defend invites an argument you do not need, when the accurate number is still comfortably under the cap.
...
**Proposed:** delete "and to produce it" from this document. (Keep it in the RFPs, where production is the point.)
...
**Proposed** (apply only if I-13 is approved):
...
**Why.** As written, Interrogatory 7 lists four categories. FIE answers those four and keeps a fifth theory in reserve for summary judgment. The catch-all closes it, and Rule 26.05 then obliges FIE to supplement if a new theory appears.
...
This is a pure legal-contention question. Of the five contention interrogatories in the set it is the most vulnerable to a **Rule 33.02** deferral objection — a party can be made to state facts; being made to brief case law is a harder sell. Interrogatory 13, once corrected under I-3, does the same work on a factual footing.
...
**Why this is the most time-critical item in either set.** FIE's **First Affirmative Defense** alleges lack of jurisdiction over it. Your Discovery Plan V5 told the Court that the documents bearing on "the identity and capacity of the contracting entity" were within Defendant's production, and asked that the amendment deadline fall after substantial completion. **The Court did not adopt that.** Scheduling Order ¶1 sets joinder at **November 16, 2026** — and a party you fail to join by then is a party you very likely cannot add.

Served now by mail, answers are due 33 days later. Serving in mid-September lands answers in late October, leaving two to three weeks to act before November 16. Serving in October does not.

RFP 34 (the underwriting file and attorney-in-fact documentation, as amended) seeks the documents. This seeks the **sworn answer**, which is what you actually need to make a joinder decision.
...
**Two Minnesota features combine badly here.**

*Expert depositions are not available as of right.* Minn. R. Civ. P. 26.02(e)(1)(A) gives you the expert **interrogatory**. Everything beyond it falls under 26.02(e)(1)(B): "Upon motion, the court may order further discovery by other means, subject to such restrictions as to scope and such provisions, pursuant to Rule 26.02(e)(3), concerning fees and expenses, as the court may deem appropriate." So deposing FIE's expert requires a motion, court-set scope, and — under (e)(3) — payment of "the expert a reasonable fee for time spent in responding to discovery." This is a real departure from federal practice, where you would simply notice the deposition.

*The Scheduling Order leaves no room to bring that motion.*

| Event | Date |
|---|---|
| All discovery closes | March 15, 2027 |
| **Defendant's expert disclosure due** | **April 17, 2027** |
| Non-dispositive motions must be **heard** by | May 14, 2027 |

FIE names its expert **a month after discovery closes**. To depose that expert you would have to move for leave, obtain a hearing date on Judge Anderson's calendar, and complete the deposition inside the 27 days between April 17 and May 14. That is not realistically achievable — Hennepin hearing dates are reserved months ahead.

**Proposed action.** Write to Kennedy Law Firm — well before March, ideally alongside service of these sets — proposing a written stipulation that:

1. each side may depose the other's retained testifying experts without motion under Rule 26.02(e)(1)(B);
2. those depositions may occur after the March 15, 2027 general discovery close, within a defined window keyed to the expert-disclosure dates; and
3. each side bears its own expert's fee for deposition time, or the parties adopt the (e)(3) default.
...
# V. The interrogatory budget — read before approving Section III

Rule 33.01(a): 50 total per party, counting **each subdivision of separate questions**, cumulative across all sets.
...
# VII. Budget review — what to remove from the First Set

*Added September 11, 2026, on a second pass focused solely on the interrogatory budget.*

## The structural point

**Interrogatories are the only capped discovery device in Minnesota.** Rule 33.01(a) allows "a total of 50 … upon any other party," cumulative across every set. Rule 34 (requests for production) and Rule 36 (requests for admission) contain **no numeric limit at all** — Rule 36.01 is silent on quantity, and Rule 34 has no cap.

That asymmetry should drive what stays in this set. An interrogatory is the right vehicle for three things only:

1. a **narrative explanation** only FIE can give ("state the basis for…", "describe the search performed…");
2. a **contention** you need pinned before depositions; and
3. a fact you want **sworn** by the party under Rule 33.01(d), because that is what makes it usable as a party admission on summary judgment.

Anything that is really a yes/no proposition belongs in an RFA. Anything answerable from documents belongs in an RFP. Six items in the current set fail that test.

## ⚠️ First, a counting risk that makes the budget worse than it looks

Interrogatories **3, 4, 5 and 6** are built as "for each X, state Y" — six exclusions, each non-window component, each 2020 line item. Counted by lettered subparts they are one each. Counted the way an adversary would argue Rule 33.01(a)'s "each subdivision of separate questions" applies, Interrogatory 3 alone could be pressed as six.

Two mitigations, both cheap:

- **State your counting method in the certification** (item I-4): "Plaintiffs count an interrogatory that calls for the same information as to each member of an identified set as a single interrogatory."
- **Do not compound the problem** by adding more "for each" constructions than the case requires.

I have not counted these aggressively in the tables below — but assume a reserve of at least 5 against this risk.
...
**Cost: 4 today, 5 if I-11 is approved — the most expensive item in the set.**

**Why it does not belong here.** Every subpart is a yes/no proposition about a contention. That is precisely what Rule 36 is for, and RFAs are uncapped. Converted:

> **REQUEST FOR ADMISSION:** Admit that the replacement cost owed for the covered windows includes the cost of detaching and resetting, or replacing, window blinds and other coverings mounted to or within those windows.

…and the same for trim, repaint, mold remediation, and a catch-all. Five RFAs, zero interrogatory cost. An RFA is also **stronger** than an interrogatory answer here: under Rule 36.02 an unanswered request is admitted, and an admission is conclusively established for the action, whereas an interrogatory answer is merely evidence.
...
**Why.** Already flagged at I-12. It is a pure request to brief case law, the most vulnerable item in the set to a Rule 33.02 deferral order, and Interrogatory 13 — once corrected to subd. 4(c) under I-3 — obtains the same ground on a factual footing FIE cannot defer as easily. FIE has also already admitted in its Answer (¶¶32, 48) that the award is binding and that the panel identified hail as the cause for the awarded windows, which is the admission *Quade* operates on.
...
**Why.** Request for Production 14, as amended and applied on September 10, now reads: "Documents sufficient to show the date on which any litigation hold, preservation notice, or document-preservation instruction concerning The Claim or this action was issued, the persons to whom it was directed, the categories of documents and data it directed to be preserved, and the date and substance of each update to it." That is the same information, sought through an uncapped device.

**The trade-off, stated honestly.** A sworn interrogatory answer is better evidence on a spoliation motion than a document production. So this is a real, if small, sacrifice. The mitigation is sequencing: if FIE's response to RFP 14 is evasive or produces nothing, serve this as a single interrogatory in the second set, where it will also be better targeted because you will know what is missing.
...
**Why trim.** Subpart **(d)** is the one that matters — what FIE actually did in *this* claim — and it is the rubber-stamp question. Subpart **(a)** identifies the people, which you need for depositions. Subparts **(b)** and **(c)** ask about generic institutional policy, which is precisely what **RFP 31** (policies governing retention, review, evaluation and acceptance of third-party reports) and **RFP 32** (documents reflecting FIE's review and adoption of the Hancock and Prieve reports) already seek in documentary form, at no budget cost.

If the documents show no independent-review process, that is better evidence than FIE's description of one.

**Saving: 2.**

`TRIM TO (a) AND (d) ☐   KEEP ALL FOUR ☐   HOLD ☐`
...
**Why defer.** FIE has not invoked J6944. The November 4, 2024 denial rested on six other exclusions — wear and tear, marring, corrosion/deterioration/rust, inherent vice or latent defect, and neglect or lack of maintenance. **J6944 is a matching argument *Plaintiffs* raised**, at Complaint ¶51, in anticipation. An interrogatory premised on a contention FIE has not made invites the answer "Defendant makes no such contention at this time," which costs you a slot and tells you nothing.

**Better sequencing.** RFP 24 already seeks the endorsement and its drafting history, and RFP 40 seeks FIE's interpretation and guidance on J6944 and *Cedar Bluff*. Let the documents come in, and let FIE take a position in response to the converted RFAs from I-21. Then ask this interrogatory in the second set, aimed at the contention FIE has actually made.
...
**Cost: 1 by lettered count — but the highest multiplication risk in the set**, because it is three questions repeated across an open-ended list of components.

**Proposed narrowing.** Strike part (i). Whether a dent *exists* in a photograph is a classic admission, and RFAs 18 and 19 already cover the downspouts and flashing; extend that pattern with a handful more RFAs (A-42, A-91–93, A-98, A-99 for downspouts; A-103, A-128, A-129 for flashing; A-136, A-141 for the sliding-door screen; A-54, A-90, A-148 for trim). Keep parts (ii) and (iii) — cause and exclusions are contentions, which is proper interrogatory work.

This both shrinks the count exposure and produces better evidence: an admission under Rule 36.02 is conclusively established, while "FIE contends the damage exists" is just an answer.
...
## I-32. Sharpen Interrogatory 9's identifiers, and add a Dates instruction — **APPLIED (both)**

> ✅ **APPLIED September 12, 2026 — both changes.** Interrogatory 9 rewritten as proposed; the Dates instruction added as **Instruction 11**, with the V5 indentation. **Count unchanged at 1** for Interrogatory 9 — added identifying detail about the same two communications is subsumed.
>
> **Numbering check, before applying.** The live set has **not** been renumbered — removals have left gaps rather than resequencing, so it runs **2–6, 9–13, 15, 17–20** and the interrogatory this item targets is still numbered **9**. Every "Interrogatory N" reference in this file therefore still points where it did on September 11. That stays true only until the single renumbering pass, which is why the mapping table is a blocking pre-service item in `../../README.md`.
>
> **Instruction number resolved.** This item deliberately declined to hard-code one. All three pending additions were applied earlier the same day — **I-7** (Instruction 8), **I-8** (Instruction 9), **I-27** (Instruction 10) — so the set now runs 1 through 11 with Dates last.
>
> ⚠️ **The proposed text silently dropped four words, and they are now gone from the live document.** Interrogatory 9 previously read "...be provided by an engineer **before You would review it**, including..."; the proposed rewrite omits that qualifier, and I applied the proposal as written and as you reviewed it. The omission is an improvement in my view — the qualifier let FIE answer that a given statement was not a *precondition to review*, and dropping it reaches any articulation of the engineer rule however framed — but it was a substantive change presented as a change to identifiers. Say the word and the qualifier goes back.
>
> ✅ **Extended to the other two sets the same day, at your direction.** The Dates instruction is now **Instruction 12** of the Requests for Production and **Instruction 6** of the Requests for Admission. The first two sentences are identical in all three; the operative verb is adapted to each device — "answer" (interrogatories), "respond and produce" (requests for production), and for the RFAs an added clause, *"rather than deny the request on the basis of the date alone,"* because Rule 36's risk is a **denial** on a date mismatch rather than a non-answer. The RFA set also uses the "Defendant / its" register rather than "You / Your", and the new instruction matches it. The Initial Disclosures were left alone — they contain no dated references framed as identifiers.
...
**Instruction numbering — resolved.** ✅ All three pending additions were applied September 12, 2026: **I-7** as Instruction 8, **I-8** as Instruction 9, **I-27** as Instruction 10. The Dates instruction is **Instruction 11**, and the set now runs 1 through 11.
...
`✅ BOTH APPLIED 2026-09-12`

---

## I-33. DROP Interrogatory 15 — the defense-universe lock moves to the RFA set — **APPLIED**

> ✅ **APPLIED September 12, 2026.** Interrogatory 15 is deleted from the live set. Saving **−1**; careful count now **26**. This was the last Section VII removal you had left open apart from **I-24**.
>
> ⚠️ **The replacement is drafted but not approved.** The defense-universe lock lives in **RFA item A-6** (Requests 41–47), and every item in the RFA proposal — A-1 through A-12 — is still pending your review. Until A-6 is approved and the requests are actually added to the RFA document, **this ground is covered by nothing**: the interrogatory is gone and its substitute exists only as a proposal. That is the one gap created today that is not closed by something already in a live document.
>
> **Why the trade is still right.** Rule 33 practice tolerates *"Defendant reserves the right to assert additional defenses as discovery proceeds"*; Rule 36.01 does not — it requires admit, deny, or a detailed statement of why neither is possible, with a reasonable-inquiry certification for any lack-of-knowledge answer, and Rule 36.02 makes an admission conclusive. The interrogatory could not do the job it was being kept for.
>
> **And the three pleaded defenses lose nothing.** Jurisdiction is attacked with far more specificity by **Interrogatory 18** (entity identity, applied today); the binding-award defense is covered in more depth by **Interrogatory 13** as corrected under I-3; and FIE's third "defense" is a general denial with no factual basis to state.
...
Mark this file up however is easiest — checkboxes, margin notes, or just the I-numbers. I will apply only what you approve, to both the `.docx` and the `.md`, renumber the new interrogatories into sequence, fill the `[NN]` in the I-4 certification from the final budget, and produce a redline of what changed.

One standing caution: interrogatory answers are sworn by FIE under Rule 33.01(d), which makes them usable as party admissions in a way a document production is not. That is the reason to spend this budget on the questions you most want locked before depositions — and the reason not to spend it on questions another deadline will answer for you.
