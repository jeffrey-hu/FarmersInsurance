...
|---|---|---|---|
| I-1 | Instruction 2: add "or penalty of perjury" and the requirement to restate each interrogatory | ⬜ Open | |
| I-2 | Instruction 3: "as Minn. R. Civ. P. 26.05 requires" | ⬜ Open | |
| I-3 | Instruction 6: check its cross-reference to Int. 14 after any renumbering | ⬜ Open | Check after F-8 |
| I-4 | Instruction 12: keep as is | ⬜ Open | No edit if accepted |
| I-5 | Confirm Baskfield's attorney number (0314572 vs. 354172) | ⬜ Open | |
| I-6 | Fill in the signature and certificate dates; serve before 5:00 p.m.; add to `Service_Log.md` | ⬜ Open | At service |
| I-7 | Keep one file to serve; label the duplicate `[Superseded 2026-09-17]`; delete the `~$` lock file | ⬜ Open | |
...
| # | Item | Fix | Status |
|---|---|---|---|
| I-1 | Instruction 2 says answers must be "under oath." Rule 33.01(d) says "under oath **or penalty of perjury**" and requires that each interrogatory be **restated** immediately before its answer. | Track the rule and add the restatement requirement, which makes the answers usable at deposition. | ⬜ Open |
| I-2 | Instruction 3: "seasonably supplement." | "…supplement or correct Your answers as Minn. R. Civ. P. 26.05 requires." | ⬜ Open |
| I-3 | Instruction 6 cross-references Int. 14. | Keep; it stays correct if Int. 14 keeps its number. | ⬜ Open |
| I-4 | Instruction 12, second sentence ("identify the specific legal entity by name…"). This was removed from the RFAs as an interrogatory-type demand, but it belongs here. | Keep | ⬜ Open |
| I-5 | Certificate of service: Baskfield's attorney number appears as **0314572** in her Notice of Appearance and as **354172** in the Answer. | Low risk. Check the Minnesota attorney registration lookup; the certificate uses the number from the Notice of Appearance. | ⬜ Open |
