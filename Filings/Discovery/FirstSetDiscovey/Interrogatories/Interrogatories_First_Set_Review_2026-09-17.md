...
**Date:** September 17, 2026 · **Tracker last updated:** September 18, 2026 (F-1 through F-11, R-2 through R-18, I-1 through I-9 and W-1 applied or decided; **old Ints. 2, 3 and 6 deleted, and the 9/17 Int. 2 and the 9/18 Int. 4 held for the Second Set — the set runs 1–14**, with **18 definitions** and **13 instructions**; fair count **about 27** of the 50-interrogatory cap, 2 reserved for expert work, working ceiling **48**; I-5, I-6, W-2 and W-3 open)
...
| ID | Step | Status |
|---|---|---|
| W-1 | **After every change is applied:** generate the `.docx` from the final `.md` per the Formatting Standard; confirm they match and Nos. 1–14 run without gaps | ✅ Applied 9/18/2026 (rebuilt four times: after the final-review fixes, after F-10/F-10a, after F-12, and after F-13). **Interrogatories:** text matches the `.md` paragraph for paragraph (86 paragraphs, caption, signature blocks and certificate included); one hanging-indent variant (0.5", −0.4", 8 pt, 49 items); Nos. 1–14 without gaps; no curly double quotes; 8 pages; preview `Claude outputs/Interrogatories_First_Set_preview_2026-09-18.pdf`. **Requests for Admission:** rebuilt the same way — 318 paragraphs matching the `.md`, 240 hanging items, Nos. 1–207 without gaps, 23 pages; preview `Claude outputs/RFA_First_Set_preview_2026-09-18.pdf` |
...
| W-2 | Recount after the edits and update §5 | ⬜ Open — running fair count is **about 27** after F-10 (+1), F-12 (−2) and F-13 (−2); §5's table still shows the pre-9/17 arithmetic |
...
**Third renumbering, September 18, 2026 (F-13).** The 9/18 Int. 4 (the October 29, 2025 statement) was also held for the Second Set. **The set now runs 1–14**: Nos. 1–3 unchanged, and the former Nos. 5–15 shifted down by one to **4–14**.
