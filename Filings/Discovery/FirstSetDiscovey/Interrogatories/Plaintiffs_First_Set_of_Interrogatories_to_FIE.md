...
**6.** No responsive information. If no information exists responsive to an interrogatory, state so expressly. If responsive information once existed but is no longer available, state that in Your answer to the interrogatory concerned, identify the information, and provide as to it each particular called for by Interrogatory 13 (destroyed or unlocatable information).
