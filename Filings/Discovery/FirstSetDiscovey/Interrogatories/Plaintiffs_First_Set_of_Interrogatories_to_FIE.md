...
**12.** Answering on behalf of others. If You do not answer on behalf of every person within the definition of "You," state which persons You have excluded, and identify, as to each answer affected, the person who has the information withheld on that basis. Where an interrogatory asks which person or entity performed an act, made a decision, or sent a communication, identify the specific legal entity by name; attributing the act to "Farmers" or "Defendant" collectively is not a complete answer.
