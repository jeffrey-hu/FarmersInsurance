...
> **REVIEWER CHANGELOG — legal-basis verification, 2026-06-28 (remove before filing).** The following edits were made to this V4 draft after an independent check of every statutory and case-law citation against the Minnesota Revisor (2025 ed.) and primary opinions. The final filed `.docx` was NOT touched. Companion memo: `Filings/Legal_Basis_Review_Memo_2026-06-28.docx`.
>
> **Edits applied:**
> 1. **¶41 — § 72A.201 pin cite corrected.** Changed "Subdivision 3(3)" to "Subdivision 9(3)." Verified: Subd. 3 is "Definitions" (3(3) defines "Claim"); the claim-file / work-papers duty quoted here is Subd. 9(3) ("Standards for communications with department"). (Keep § 72A.201 framed only as a records-preservation duty supporting the Rule 37 / adverse-inference request — Minnesota recognizes no private right of action under ch. 72A, and subd. 1 bars using a violation as a § 8.31 predicate.)
> 2. **Decl. (g) — § 65A.26 reframed.** Now leads with the policy's express two-year term and waiver/estoppel as the primary grounds, and characterizes the one-year § 65A.26 hail clause as inapplicable to a homeowner's policy written on the § 65A.01 standard-fire-policy form (rather than "superseded by" § 65A.01). The "supersession" theory was the weakest leg. NOTE: this argument is only as good as the policy form — confirm the actual suit-limitation language in the HomePolicy docs / MN080 (see risk row V-4).
> 3. **§ 325F.70 pin-cited to subd. 3** throughout (Intro ¶1, ¶3, Count IV heading, ¶72, ¶73, Prayer ¶D). The consumer private right of action with the built-in "benefits the public" declaration was added as § 325F.70, subd. 3 in 2023; pinning to subd. 3 strengthens the public-benefit answer to *Ly v. Nystrom*, 615 N.W.2d 302 (Minn. 2000). § 8.31, subd. 3a retained in the alternative. (Subd. 3 is new and largely untested in the appellate courts — flag as developing law.)
> 4. **Prayer ¶F — § 549.09 postjudgment-interest cite tightened** to Subd. 2 (continuing accrual), noting Subd. 1(a) covers verdict-to-judgment and Subd. 1(c) sets the rate.
> 5. **¶68 — § 325F.69 conduct list** updated to add "unfair or unconscionable practices," tracking the 2023 amendment to § 325F.69, Subd. 1.
>
> **Advisory — verified accurate, no text change, your call:**
> - **¶70 — *Force v. ITT Hartford*, 4 F. Supp. 2d 843, 858 (D. Minn. 1998):** proposition (insurance = "merchandise") verified; pinpoint "858" could not be confirmed on free sources — confirm on Westlaw/Lexis. It is persuasive D. Minn. authority only, not binding.
> - **¶¶65, Prayer ¶C — *Cincinnati Ins. Co. v. Rymer Cos.*, No. 24-3356 (8th Cir. Mar. 27, 2026):** verified it exists and supports clarification-remand under Minnesota law; cite as a slip opinion (no F.4th/N.W.3d reporter yet). Do not confuse with the earlier *Rymer*, 41 F.4th 1026 (8th Cir. 2022).
> - **¶¶51, decl. (e) — *Cedar Bluff*, 857 N.W.2d 290 (Minn. 2014):** verified, but it is a siding/replacement-cost holding; the windows application is by analogy — keep it framed that way.
> - **¶66 / Count III vacatur — *Mork*, 230 Minn. 382, 42 N.W.2d 33 (1950):** verified, but the standard is demanding (fraud / misfeasance / malfeasance / wrongdoing, or fraud-level gross inadequacy). Vacatur is correctly pleaded only as the final alternative; ensure the asserted grounds are framed as panel wrongdoing, not ordinary defect.
> - **§ 604.18 reservation (¶8, Prayer ¶H):** procedure is correct (post-pleading motion under subd. 4(a)). Watch subd. 4(c): taxable costs are "not available in any claim that is resolved or confirmed by … appraisal." Preserve the argument that the contract claim reaches well beyond what the appraisal resolved.
...
30. On August 3, 2025, Pure Construction, on behalf of Plaintiffs, filed a formal Demand for Appraisal under Minn. Stat. § 65A.01, naming claim 7007986837-1-1, loss date July 13, 2024, and three separate items in dispute — Windows, Siding (repaint), and Siding (replace and remove) — the latter two submitted as distinct siding items, each requiring a separate statement of actual value and loss under Minn. Stat. § 65A.01, Subd. 3. Plaintiffs filed a Sworn Statement on Proof of Loss with the demand stating a total claimed loss of $310,000 against Coverage A of $886,000 with a $17,720 deductible.
...
52. **The replacement cost owed for the covered windows includes the necessary incidental costs of completing the replacement.** The policy's replacement-cost obligation is the full, reasonable cost to repair or replace the damaged property — including work the window replacement necessarily requires, such as removing window blinds and coverings, restoring disturbed trim, and exterior repainting. Because the replacement windows are current-production equivalents of the discontinued Semco units (paragraph 51) and differ in dimension, inside-mounted blinds sized to the original windows cannot be reused and must be replaced. Plaintiffs have also suffered consequential water-intrusion and mold damage from the leaking windows (paragraph 40). The award's lump-sum $12,800 Replacement Cost Value neither itemized nor included any of these costs. These incidental costs, together with the replacement cost of the windows the panel did not evaluate (paragraph 49(a)) and the matching cost (paragraph 51), bring the full replacement cost of the covered loss above the policy's $17,720 windstorm/hail deductible; coverage for and the amount of these costs remain live questions for the Court, unforeclosed by an award that did not address them.
...
56. A justiciable controversy exists between Plaintiffs and Defendant under Policy 98055-49-65 with respect to the July 13, 2024 hail loss. Defendant has denied coverage twice in writing, has paid nothing following a binding appraisal award confirming hail causation, and maintains that the claim is "settled per the binding appraisal award received"; Plaintiffs dispute each of those positions.
...
### COUNT IV — MINNESOTA CONSUMER FRAUD ACT (Minn. Stat. § 325F.69, enforced through Minn. Stat. § 325F.70, subd. 3 and § 8.31, Subd. 3a)
...
B. **On Count II (Declaratory Judgment):** A declaratory judgment in the form set forth in paragraph 57 above, together with such supplemental relief as is necessary or proper under Minn. Stat. § 555.08.

C. **On Count III:** A declaration that the September 12, 2025 appraisal award, not being "so itemized" under Minn. Stat. § 65A.01, Subd. 3, is not a binding determination of the full amount of loss and does not preclude Count I as to any window, sash, or item the award did not separately itemize, while remaining binding on Defendant as to the panel's hail-causation finding; or, in the alternative, an order modifying or correcting the award to comply with Minn. Stat. § 65A.01, Subd. 3; or, in the further alternative, an order remanding the award to the appraisal panel for clarification under *Herll v. Auto-Owners Insurance Co.* and *Cincinnati Insurance Co. v. Rymer Cos.* in the form set forth in paragraph 65 above; or, in the final alternative, an order vacating the award under *Mork v. Eureka-Security Fire & Marine Insurance Co.*

D. **On Count IV (Minnesota Consumer Fraud Act):** Compensatory damages, costs and disbursements (including costs of investigation), and reasonable attorney fees pursuant to Minn. Stat. § 325F.70, subd. 3 and, in the alternative, Minn. Stat. § 8.31, Subd. 3a.
...
F. **Postjudgment interest** under Minn. Stat. § 549.09, Subd. 2 (verdict-to-judgment interest under Subd. 1(a) and continuing accrual under Subd. 2, at the rate set by Subd. 1(c)).
