# DRAFT COMPLAINT — VERSION 4 (FINAL DRAFT)

**Status:** Final draft for pre-filing review. NOT FILED.
**Forum:** State of Minnesota, District Court, Fourth Judicial District (Hennepin County).
**Filing deadline:** July 13, 2026 (2-year contractual suit limitation; see Appendix A, item V-4/V-5 — file as soon as practicable).
**Prepared:** June 12, 2026.
**Controlling sources:** `01_Overview_Complaint_Draft.md` (count selection, ordering, relief sequencing); `Draft_Complaint_v2_Balanced.md` (paragraph language base); `LegalReferences/LegalArguments/A1.md`–`E4.md` (controlling argument ratings).
**Posture:** Plaintiffs file pro se. Four counts: I — Breach of Contract; II — Declaratory Judgment; III — Non-Preclusion Declaration / Modification / (Reserved) Remand / (Last) Vacatur of the Appraisal Award; IV — Minnesota Consumer Fraud Act. Counts for fraud/negligent misrepresentation (B2), unjust enrichment (A4), negligent claims handling (B3), standalone estoppel (B4), and regulatory statutes (C1/C2/C4) are intentionally omitted. Bad faith under Minn. Stat. § 604.18 is reserved for a post-filing motion under Subd. 4(a). No punitive-damages reservation (no carrier tort is pleaded).

> The body below is drafted as filing-ready text. The pre-filing verification checklist and exhibit list appear in Appendices A and B after the signature block. **Remove both appendices before filing.**
...
Fire Insurance Exchange, by and            COMPLAINT AND
through its attorney-in-fact, Fire         DEMAND FOR JURY TRIAL
...
1. This is an action for breach of an insurance contract; for declaratory judgment construing that contract under Minn. Stat. ch. 555; for a declaration that the September 12, 2025 appraisal award entered under Minn. Stat. § 65A.01 — not being itemized as that statute requires — does not preclude Plaintiffs' contract claim as to any window or item the award did not itemize, or in the alternative to modify, correct, clarify, or vacate that award; and for damages and statutory remedies under the Minnesota Consumer Fraud Act, Minn. Stat. § 325F.69, enforced through Minn. Stat. § 325F.70 and Minn. Stat. § 8.31, Subd. 3a.
...
3. Plaintiffs seek monetary damages, declaratory relief, a declaration that the September 12, 2025 appraisal award is non-preclusive as to the scope it did not itemize (or, in the alternative, modification, correction, clarification, or vacatur of that award), prejudgment and postjudgment interest, statutory costs of investigation and attorney fees under Minn. Stat. § 325F.70 and § 8.31, Subd. 3a, and such further relief as the Court deems appropriate. Plaintiffs reserve the right to seek statutory taxable costs under Minn. Stat. § 604.18 by post-pleading motion under Minn. Stat. § 604.18, Subd. 4(a).
...
38. **An entire window on the home appears nowhere in Defendant's inspection record.** A two-sash fixed window, approximately two feet by two feet, is located on the front elevation of Plaintiffs' attached garage, to the right of the garage door, partially obstructed by a shed, and accessible only through a narrow gap between the shed and the house wall or by passing through the shed. Defendant's own records (the 2023 renewal's "Information We Have About Your Home") describe the garage as a three-car attached garage, insured under Coverage A. The Prieve Engineering report — whose stated scope was to "evaluate the condition of windows in the home as relates to hail" — contains no photograph of this window anywhere in its 217-photograph Photo Appendix A and no mention of it in its narrative or Conclusions; the only garage window the report documents is a different, two-unit window on the rear/east elevation (photographs A-213 through A-217). On information and belief, neither Prieve Engineering nor any other person acting for or retained by Defendant has ever inspected this window, and no inspection record, photograph, or evaluation of it exists in Defendant's claim file or in the appraisal record.
...
41. The following records, each of which Defendant or its agents had a duty to create or preserve, do not exist or have not been produced despite Plaintiffs' written requests: (a) any written report, notes, or record of Defendant's own adjuster Nicholas Brau's September 6, 2024 onsite inspection, at which Mr. Brau personally observed dents on multiple windows and measured window dimensions — Defendant stated in writing on October 10, 2025 that "the file does not contain a report on the requested date," while Mr. Brau stated on October 29, 2025 that "all the information we can release has already been sent to you"; (b) any report or estimate from the appraisal umpire — Defendant confirmed in writing on September 24, 2025 that none exists; and (c) the line-item identification of which windows or sashes were within the 2020 claim's scope, which Plaintiffs have repeatedly requested. Defendant is a regulated property insurer subject to the claim-file documentation requirements of Minn. Stat. § 72A.201, including Subdivision 3(3), which makes it an unfair claims practice to fail to include in the claim file all written communications and transactions emanating from or received by the insurer, as well as all notes and work papers relating to the claim, and knew or should have known, at all times after its September 3, 2024 denial, that its claim file would be material to reasonably foreseeable litigation. Plaintiffs reserve the right to seek discovery sanctions under Minn. R. Civ. P. 37 and an adverse-inference instruction at trial.

### L. Manufacturer Discontinuation of the Insured Windows

42. The insured windows are, on information and belief, manufactured by Semco Windows and Doors of Merrill, Wisconsin, with manufacturer stamps in the sashes from 1993, 1997, and 2008.

43. Semco Windows and Doors ceased operations on December 31, 2019. Sierra Pacific Windows acquired Semco's operating assets in February 2020 and did not continue manufacturing Semco's product line. On information and belief, current-production matching profiles for the windows' specific 1993, 1997, and 2008 sash stamps are not available, requiring use of comparable current-production extruded aluminum equivalents (such as Pella Reserve Traditional or Marvin Ultimate, identified by Plaintiffs and their contractor on June 12, 2025) for any replacement.
...
46. Policy 98055-49-65 is a valid and enforceable contract. The policy was in force on July 13, 2024.
...
54. Plaintiffs reallege and incorporate paragraphs 1 through 53 above.

55. A justiciable controversy exists between Plaintiffs and Defendant under Policy 98055-49-65 with respect to the July 13, 2024 hail loss. Defendant has denied coverage twice in writing, has paid nothing following a binding appraisal award confirming hail causation, and maintains that the claim is "settled per the binding appraisal award received"; Plaintiffs dispute each of those positions.

56. Plaintiffs request a judicial declaration, pursuant to Minn. Stat. §§ 555.01–.16, that:
...
57. The requested declarations will substantially terminate the controversy between the parties as required by Minn. Stat. § 555.06.
...
### COUNT IV — MINNESOTA CONSUMER FRAUD ACT (Minn. Stat. § 325F.69, enforced through Minn. Stat. § 325F.70 and § 8.31, Subd. 3a)

66. Plaintiffs reallege and incorporate paragraphs 1 through 65 above.

67. Defendant engaged in a course of misrepresentation, misleading statements, and deceptive practices in violation of Minn. Stat. § 325F.69, Subd. 1, in connection with the sale and renewal of homeowner's insurance Policy 98055-49-65 to Plaintiffs for personal, family, and household purposes.

68. The prohibited conduct includes, without limitation:
...
A. **On Count I (Breach of Contract):** Compensatory damages in excess of $50,000, in an amount to be proven at trial.

B. **On Count II (Declaratory Judgment):** A declaratory judgment in the form set forth in paragraph 56 above, together with such supplemental relief as is necessary or proper under Minn. Stat. § 555.08.

C. **On Count III:** A declaration that the September 12, 2025 appraisal award, not being "so itemized" under Minn. Stat. § 65A.01, Subd. 3, is not a binding determination of the full amount of loss and does not preclude Count I as to any window, sash, or item the award did not separately itemize, while remaining binding on Defendant as to the panel's hail-causation finding; or, in the alternative, an order modifying or correcting the award to comply with Minn. Stat. § 65A.01, Subd. 3; or, in the further alternative, an order remanding the award to the appraisal panel for clarification under *Herll v. Auto-Owners Insurance Co.* and *Cincinnati Insurance Co. v. Rymer Cos.* in the form set forth in paragraph 64 above; or, in the final alternative, an order vacating the award under *Mork v. Eureka-Security Fire & Marine Insurance Co.*

D. **On Count IV (Minnesota Consumer Fraud Act):** Compensatory damages, costs and disbursements (including costs of investigation), and reasonable attorney fees pursuant to Minn. Stat. § 325F.70 and, in the alternative, Minn. Stat. § 8.31, Subd. 3a.

E. **Prejudgment interest** under Minn. Stat. § 549.09, Subd. 1(b), accruing from the earliest of August 13, 2024 (Plaintiffs' written notice of claim), August 3, 2025 (Plaintiffs' Demand for Appraisal), or such other earliest date the Court determines is appropriate, on all pecuniary damages awarded. *See Poehler v. Cincinnati Insurance Co.*, 899 N.W.2d 135 (Minn. 2017).

F. **Postjudgment interest** under Minn. Stat. § 549.09, Subd. 1(a).

G. **Costs and disbursements** under Minn. Stat. §§ 549.02 and 549.04.

H. **Such further relief**, legal and equitable, as the Court deems just and proper, including any remedy available to Plaintiffs under Minnesota law that Plaintiffs may seek by post-pleading motion, including but not limited to taxable costs under Minn. Stat. § 604.18 by motion under Subd. 4(a).
...
*Both Plaintiffs sign. Under Minn. R. Civ. P. 11, each signing party certifies that the factual allegations have evidentiary support (or are specifically identified as made on information and belief) after reasonable inquiry.*

---
---

## APPENDIX A — PRE-FILING VERIFICATION CHECKLIST (REMOVE BEFORE FILING)

This appendix is internal work product. **It must be removed, together with Appendix B and the header block above the caption, before the complaint is filed.** Items are keyed to the verification gates in `01_Overview_Complaint_Draft.md` § 8.

| # | Item | Affects | Status / action |
|---|---|---|---|
| V-1 | **Front-of-garage window (¶ 38, ¶ 49(a)(ii), ¶ 52).** Pleaded as LIVE TEXT per family decision (6/12/2026): the family has personally seen the window on their own house and is confident in its existence and location. **Be extra sure before filing:** create (1) a dated photograph showing the window, the shed obstruction, and the relationship to the garage door and house wall; (2) a measured site sketch; (3) a note of the access path; and (4) if feasible, photographs of the window itself for hail signatures. Re-check Photo Appendix A one final time to confirm no photograph of this window appears anywhere in it. If any of this cannot be confirmed, strike ¶ 38 and the cross-references before filing. | ¶¶ 38, 49(a)(ii), 52 | **OPEN — family action, required before filing** |
| V-2 | **2020 per-sash scope (dining-room window).** `FinalDocument_2020.pdf` confirms the whole 2020 window scope was 2 casement units (line items 1–4); which windows/sashes is not identified. ¶ 37 / ¶ 49(a)(i) / decl. (h) / ¶ 61 / ¶ 68(f) are pleaded on information and belief — corroborated by the family's 9/23/2025 email ("the prior damage to dining room's window was on the middle sash"). 2020 photo log remains a discovery target. Also pin down whether the 2020 window work was ever completed (the 2/18/2022 worksheet lists it under "Work Not Completed"). | ¶¶ 37, 49(a)(i), 56(h), 61, 68(f) | PARTIALLY VERIFIED — pleaded on information and belief; OK to file |
| V-3 | **Semco vs. Senco; window material.** Public sources confirm Semco (Merrill, WI) closed 12/31/2019 and Sierra Pacific did not continue the product line. But Farmers' emails say "Senco," and an active company by that name exists. **Photograph the physical sash stamps (1993/1997/2008) before filing**; if the stamp reads SENCO, amend ¶¶ 42–43, ¶ 51, and decl. (e). Confirm window material (extruded aluminum vs. clad). | ¶¶ 42–43, 51, 56(e) | OPEN — family action; pleaded on information and belief |
| V-4 | **MN080 endorsement text — HIGHEST PRIORITY.** Text is in no project document. Request a certified complete policy copy (all endorsements) from agent Pietila / Farmers immediately. Check for (a) any one-year hail suit-limitation carve-out (would make the protective ¶¶ 28–29 and decl. (g) load-bearing) and (b) any preaward-interest preclusion (would shrink Prayer ¶ E). **Verified 6/12/2026 (Revisor):** Minn. Stat. § 65A.26 ("Hail Insurance, Policies, Loss Adjustment") mandates a one-year suit limitation in standard hail policies, and Minnesota carriers have been splitting policies (2-year fire / 1-year hail) in recent years; if MN080 or any other endorsement adopts the one-year hail clause, the nominal deadline was 7/13/2025 and the case depends on (i) the policy's express 2-year Section I term controlling, (ii) the argument that § 65A.26 governs standalone hail policies (separate "HAIL INSURANCE" heading in ch. 65A) rather than homeowners policies taking the § 65A.01 form, and (iii) the ¶¶ 28–29 waiver/estoppel record. Filing early does not de-risk this — only reading MN080 does. | ¶¶ 10, 28–29, 56(g), Prayer E; filing-date analysis | **OPEN — request immediately** |
| V-5 | **File early.** The base policy form gives 2 years (deadline 7/13/2026). If MN080 contains a one-year clause, the nominal deadline has already passed and the answer is the waiver/estoppel record pleaded at ¶¶ 28–29. Regardless: file as soon as practicable, well before 7/13/2026. | Filing date | RULE — file ASAP |
| V-6 | **Cite-checks before any brief:** *Mork* "surplusage" label against full opinion text; *Herll*/*Rymer* are 8th Circuit (persuasive, not binding, in Hennepin County); § 555 text against the current Revisor version; Shepardize/KeyCite everything if Westlaw/Lexis access becomes available. The complaint's citations are believed accurate but were verified from free sources. | Counts II–III; briefing | SUBSTANTIALLY VERIFIED (free sources) |
| V-7 | **Party status.** Resolved: ¶ 4 pleads Yibiao Lu as named insured and Jie Hu as spouse/resident insured under the policy's definition of "you" — do not change both to "named insureds." | ¶ 4, caption | RESOLVED — pleaded accordingly |
| V-8 | **Dining-room ≠ awarded F1.7 window.** Documents support that the awarded front window (1-sash, corner of stairs) is distinct from the excluded front dining-room window. Walk the front elevation and confirm physically before filing; if they are the same window, rework ¶ 37, ¶ 49(a)(i), decl. (h), and ¶ 61. | ¶¶ 37, 49(a)(i), 56(h), 61 | SUPPORTED BY RECORD — physical confirmation open |

**Other reminders.**
- The § 604.18 bad-faith claim is NOT pleaded (statutorily prohibited in an initial complaint); it is reserved in Prayer ¶ H and added later by Subd. 4(a) motion with affidavits.
- No punitive-damages reservation is included (no carrier tort is pleaded — B2 was excluded by family decision 6/12/2026).
- The hail-shape science appears only in ¶ 22(i); everything else deploys post-filing (de novo proof, remand-order shaping, Frye-Mack/Rule 702 motion against Prieve — not "Daubert" in state court).
- Sequencing rule (load-bearing): depose Foster, Roos, and Tomes (Move 1) before any remand motion under Count III ¶ 64.
- Honest-risk notes carried from `01_Overview` § 10: the evaluated-but-rejected scenario remains the central structural risk; the burden of proving appraisal scope is unsettled; no Minnesota case squarely supports the "so itemized" non-preclusion theory; the panel inspected the property itself on 9/12/2025, so "never evaluated" is an inference to be converted to record in discovery.

---

## APPENDIX B — PROPOSED EXHIBIT LIST (REMOVE BEFORE FILING; ATTACH EXHIBITS PER LOCAL PRACTICE)

- Exhibit A — Policy 98055-49-65, complete certified copy including all endorsements (pending V-4; interim source: `HomePolicy/2014_newBusiness_policy.pdf`)
...
- Exhibit D — November 4, 2024 denial letter and Prieve report with Photo Appendix A (`EventDocuments/FarmersDenyLetter-11-4.pdf`; `FarmersDenyLetter-11-4-AppendixA.pdf`)
- Exhibit E — 2020 claim Settlement Notice and Xactimate (`EventDocuments/FinalDocument_2020.pdf`)
...
- Exhibit H — January 31, 2025 written appeal package (`EventDocuments/2025-01-31-ResponseToFarmer.pdf` and attachments)
- Exhibit I — February 10, 2025 second response with neighbor canvass and City permit records (`EventDocuments/2025-02-10-SecondResponseToFinalReport.pdf`)
- Exhibit J — Demand for Appraisal and Sworn Statement on Proof of Loss (`EventDocuments/Appraisal Documents/AppraisalDemand.pdf`)
- Exhibit K — September 12, 2025 Appraisal Award, front and back (`Appraisal_Result_Front.png`; `Appraisal_Result_Back.png`)
- Exhibit L — Post-appraisal correspondence including the September 18/19 and October 14, 2025 scope descriptions (`2025-09-18-PostAppraisalEmailChain.md`; `2025-09-19-ResponseFromFarmers.pdf`)
- Exhibit M — NWS Twin Cities/Chanhassen storm documentation (`Evidence/Significant Wind and Hail in Minnesota July 13-14.pdf`)
- Exhibit N — Department of Commerce complaint (`EventDocuments/11-19-complaint-to-dept-of-commerce.pdf`)
- Exhibit O — July 10–11, 2025 deadline-inquiry email exchange (from `EventDocuments/Copy of ComunicationLogs.docx.md`)
- Exhibit P — Dated photograph and measured site sketch of the front-of-garage window and shed obstruction (TO BE CREATED — Gate V-1)

---

*End of Draft Complaint V4 — Final Draft. Supersedes v1–v3 as the operative draft; controlled by `01_Overview_Complaint_Draft.md`.*
