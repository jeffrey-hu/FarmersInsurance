...
16. **Second inspection (September 6, 2024).** Defendant's own Claims Specialist Representative — Property, Nicholas Brau, personally inspected the property. During the inspection, Mr. Brau identified dents on multiple windows alongside Plaintiffs and measured window dimensions, and wrote notes and drew windows with dimensions on his paper notebook. Defendant has subsequently asserted, in a written communication on October 10, 2025, that "the file does not contain a report on the requested date." On October 29, 2025, Mr. Brau personally responded to Plaintiffs' request for his notes by stating "all the information we can release has already been sent to you" — a statement in tension with Defendant's "no report exists" position.
...
30. On August 3, 2025, Pure Construction, on behalf of Plaintiffs, filed a formal Demand for Appraisal under Minn. Stat. § 65A.01, naming claim 7007986837-1-1, loss date July 13, 2024, and three items in dispute: Windows, Siding (repaint), and Siding (replace and remove). Plaintiffs filed a Sworn Statement on Proof of Loss with the demand stating a total claimed loss of $310,000 against Coverage A of $886,000 with a $17,720 deductible.
...
| V-3 | **Semco vs. Senco; window material.** Public sources confirm Semco (Merrill, WI) closed 12/31/2019 and Sierra Pacific did not continue the product line. But Farmers' emails say "Senco," and an active company by that name exists. **Photograph the physical sash stamps (1993/1997/2008, plus the 2014 sash on the awarded family-room window) before filing**; if the stamp reads SENCO, amend ¶¶ 42–43, ¶ 51, and decl. (e). Confirm window material (extruded aluminum vs. clad). | ¶¶ 42–43, 51, 56(e) | OPEN — family action; pleaded on information and belief |
